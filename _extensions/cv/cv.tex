...
% Pandoc CSL macros (matches the definitions modern pandoc's own default
% LaTeX template generates for --citeproc output - our template needs to
% define these itself since it doesn't extend pandoc's default template).
